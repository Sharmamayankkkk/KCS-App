...
const MeetingRoom = ({ apiKey, userToken, userData }: MeetingRoomProps) => {
  ...
  const CallLayout = () => {
    // Force grid layout when screen is being shared for better visibility
  ...
  // Handle sidebar panels (chat and participants)
        ...
        <StreamCall call={call}>
          <section className="relative h-screen w-full overflow-hidden pt-2 md:pt-4 text-white">
            <div className="relative flex size-full items-center justify-center">
              {/* Main video area - adjust width based on sidebar visibility */}
              <div 
                className={cn(
            ...
            {/* ✅ Controls - Fixed at bottom with better mobile support */}
