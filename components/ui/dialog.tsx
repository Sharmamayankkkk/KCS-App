...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn('fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border-none bg-background p-6 shadow-soft duration-200 animate-in fade-in-0 zoom-in-95 sm:rounded-2xl', className)}
      {...props}
    >
      {children}
