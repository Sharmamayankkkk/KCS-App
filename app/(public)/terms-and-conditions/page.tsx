...
const TermsAndConditions = () => {
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 text-gray-800">
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-2xl font-semibold">Content Ownership and Licensing</h2>
        ...
        <h3 className="mb-1 mt-4 text-lg font-medium">Responsibility for Rights</h3>
        <p>
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-2xl font-semibold">Age and Regional Restrictions</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-2xl font-semibold">Disclaimers and Limitations of Liability</h2>
        <ul className="list-inside list-disc space-y-1">
      ...
      <section className="mb-8">
        <h2 className="mb-2 text-2xl font-semibold">Intellectual Property and DMCA</h2>
        <ul className="list-inside list-disc space-y-1">
