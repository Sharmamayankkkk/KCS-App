      ...
      <div className="space-y-8">
        ...
        <section className="rounded-lg border border-gray-200 bg-gray-50 p-6 shadow-sm">
          ...
          <p>
            ...
            that allows users to support content creators during live sessions
            by sending highlighted messages. These contributions are voluntary
            and processed via integrated payment gateways.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm italic text-gray-500">
            Note: Each Super Chat message can contain a maximum of 200
            characters.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-gray-200 bg-gray-50 p-6 shadow-sm">
          ...
          <p>
            All Super Chat contributions are final and non-refundable. By
            contributing, you acknowledge that:
          </p>
          <ul className="mt-2 list-inside list-disc space-y-1">
            <li>
              The contribution is made voluntarily to support the content
              creator.
            </li>
            <li>
              Once processed, it cannot be refunded, reversed, or charged back.
            </li>
          </ul>
          <p className="mt-2 text-sm text-gray-500">
            This aligns with industry standards such as YouTube&apos;s Super Chat
            policy.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <ul className="mt-2 list-inside list-disc space-y-1">
            <li>
              <strong>Technical Failures:</strong> Paid but not delivered due to
              server or gateway errors.
            </li>
            <li>
              <strong>Unauthorized Transactions:</strong> Made without your
              consent and proven with evidence.
            </li>
          </ul>
        </section>
        ...
        <section className="rounded-lg border border-gray-200 bg-gray-50 p-6 shadow-sm">
          ...
          <ol className="mt-2 list-inside list-decimal space-y-1">
            <li>
              ...
              <strong>&quot;Super Chat Refund Request&quot;</strong>.
            </li>
            <li>
          ...
          <p className="mt-2 text-sm text-gray-500">
            Our team will respond within 7 business days. Submission doesn’t
            guarantee approval.
          </p>
        </section>
        ...
        <section className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-500">
            If approved, refunds will be processed back to the original payment
