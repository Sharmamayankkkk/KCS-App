...
const HomePage = () => {
  return (
    <div className="w-full">
      <section className="relative bg-[#F8FAFC] py-20 md:py-32">
        <div className="absolute inset-0 bg-[url(/grid.svg)] bg-center [mask-image:linear-gradient(180deg,white,rgba(255,255,255,0))]"></div>
        <div className="relative mx-auto max-w-6xl px-4 text-center sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-[#0F172A] sm:text-5xl md:text-6xl lg:text-7xl">
            <span className="block">India&apos;s First</span>
            <span className="block text-[#B91C1C]">
              Spiritually Inspired Communication Platform
            </span>
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-[#64748B] sm:text-xl md:text-2xl">
          ...
          <div className="mt-10 flex justify-center gap-4">
            <Link
              href="/sign-up"
              className="inline-flex items-center justify-center rounded-full bg-[#B91C1C] px-8 py-3.5 text-base font-semibold text-white shadow-md transition-all hover:bg-[#991B1B] hover:shadow-lg"
            >
              Get Started for Free
            </Link>
            <Link
              href="/compare"
              className="inline-flex items-center justify-center rounded-full bg-white px-8 py-3.5 text-base font-semibold text-[#0F172A] shadow-md ring-1 ring-inset ring-border transition-all hover:bg-[#F8FAFC] hover:shadow-lg"
            >
